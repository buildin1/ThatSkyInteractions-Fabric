...
public class BedrockAnimationParser {
     ...
     * }
     * */
    // 1.20.1 的 Codec 没有实例方法 withAlternative，改用 ExtraCodecs 的静态形式（可嵌套）
    private static final Codec<BedrockKeyframe> KEYFRAME_RECORD_CODEC =
            RecordCodecBuilder.create(instance -> instance.group(
                            dev.anvilcraft.lib.v2.codec.CodecCompat.VECTOR3FC.fieldOf("post").forGetter(BedrockKeyframe::post),
                            dev.anvilcraft.lib.v2.codec.CodecCompat.VECTOR3FC.optionalFieldOf("pre").forGetter(BedrockKeyframe::pre),
    ...
    public static final Codec<BedrockKeyframe> KEYFRAME_CODEC = dev.anvilcraft.lib.v2.codec.CodecCompat.withAlternative(
            KEYFRAME_RECORD_CODEC,
            dev.anvilcraft.lib.v2.codec.CodecCompat.VECTOR3FC.xmap(
                    BedrockKeyframe::of,
                    BedrockKeyframe::post
            )
    );

    private static final Codec<BedrockTimeline> TIMELINE_MAP_CODEC =
            Codec.unboundedMap(
                    Codec.STRING.xmap(
                            Float::parseFloat,
                            f -> Float.toString(f)
    ...
    public static final Codec<BedrockTimeline> TIMELINE_CODEC = dev.anvilcraft.lib.v2.codec.CodecCompat.withAlternative(
